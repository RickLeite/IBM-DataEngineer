...
test6={
    "testname":"Check for min and max v2",
    "test":check_for_min_max,
    "column": "quarter",
    "table": "DimMonth",
    "minimum":1,
...
test8={
    "testname":"Check for duplicates v2",
    "test":check_for_duplicates,
    "column": "customerid",
    "table": "DimCustomer"
}
...
test10={
    "testname":"Check for duplicates - EX",
    "test":check_for_duplicates,
    "column": "billid",
    "table": "FactBilling"
}
...
test11={
    "testname":"Check for valid values - EX",
    "test":check_for_valid_values,
    "column": "quarter",
    "table": "DimMonth",
